            ...
            <div class="bg-white w-full h-full overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-col justify-center items-start p-6 bg-white">
                    <div class="flex justify-center">
                        <span class="text-pink-600 inline-block"><i class="fa fa-stethoscope fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-search fa-3x" aria-hidden="true"></i></span>
                    ...
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-address-book fa-3x"></i></span>
                    ...
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-bars fa-3x" aria-hidden="true"></i></span>
                    ...
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-upload fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-print fa-3x" aria-hidden="true"></i>
                        </i>
                        </span>
                        <x-nav-link class="ml-6" :href="route('patient.show.prescription')" :active="request()->routeIs('patient.show.prescription')">
                            {{ __('Show My payment receipt') }}
                        </x-nav-link>
                    </div>
                    
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-eye fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center  mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-comments fa-3x" aria-hidden="true"></i></span>
