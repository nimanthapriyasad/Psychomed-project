            ...
            <div class="bg-white w-full h-full overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex flex-col justify-center items-start p-6 bg-white">
                    <div class="flex justify-center">
                        <span class="text-pink-600 inline-block"><i class="fa fa-bars fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-user fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center mt-6">
                        <span class="text-pink-600 inline-block"><i class="fa fa-user-md fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center mt-6">
                        <span class="text-pink-800 inline-block"><i class="fa fa-search fa-3x" aria-hidden="true"></i>
                        </span>
                    ...
                    <div class="flex justify-center mt-6">
                        <span class="text-pink-800 inline-block"><i class="fa fa-search fa-3x" aria-hidden="true"></i></span>
