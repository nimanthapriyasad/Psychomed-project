                ...
                <div class="min-w-full mt-6">
                    <div class="bg-white">
                        ...
                        <ul>
                            ...
                            <li class="px-6 py-4 whitespace-no-wrap border-b text-pink-900 border-gray-500 text-sm leading-5">Patient's Email : {{$item->email}}</li>
                            <li class="px-6 py-4 whitespace-no-wrap border-b text-pink-900 border-gray-500 text-sm leading-5">Patient's Phone : {{$item->mobileNumber}}</li>
