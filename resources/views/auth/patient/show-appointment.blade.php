                    ...
                    <div class="bg-white">
                        ...
                        <ul>
                            <li class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                <div class="text-sm leading-5 text-pink-900">Doctor's Name :  {{$item->name}}</div>
                            </li>
                            <li class="px-6 py-4 whitespace-no-wrap border-b text-pink-900 border-gray-500 text-sm leading-5">Doctor's Email : {{$item->email}}</li>
                            <li class="px-6 py-4 whitespace-no-wrap border-b text-pink-900 border-gray-500 text-sm leading-5">Doctor's Phone : {{$item->mobileNumber}}</li>
                            ...
                            <li class="px-6 py-4 whitespace-no-wrap border-b border-gray-500 text-pink-900 text-sm leading-5">Appointment Date : {{$item->date}}</li>
                            ...
                            <div class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-500 text-sm leading-5">
                                <button class="px-5 py-2 border-pink-500 border text-pink-500 rounded transition duration-300 hover:bg-pink-700 hover:text-white focus:outline-none">
